<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="com.gn.board.vo.Board, com.gn.board.vo.Attach, java.time.format.*" %>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
			...
			<div class="board_detail">
				<ul>
					<li>
						...
						<br>
						<a href="<%=request.getContextPath()%>/fileDownload?attach_no=<%=board.getAttachNo()%>">이미지파일 다운로드</a>
					</li>
					<li>
						<table>
							<tr>
